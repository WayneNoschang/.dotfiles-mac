...
# setopt noflowcontrol  # Flow control pauses terminal i/o (Ctrl-S), press (Ctrl-Q) to resume. Useful for commands with long output (e.g. `\ls -R`).
...
# setopt nobanghist         # Turn off bang (!) history expansion.
