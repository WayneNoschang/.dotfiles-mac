...
# Returns true if any functions have been associated with Zsh hooks
zhooks() {
...
# Unload function: https://github.com/agkozak/Zsh-100-Commits-Club/blob/master/Zsh-Plugin-Standard.adoc#unload-fun
